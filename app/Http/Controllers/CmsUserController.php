...
class CMSUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('cms.users.index')->with('success', 'Korisnik je uspješno stvoren.');
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect()->route('cms.users.index')->with('success', 'Korisnik je uspješno ažuriran.');
    }
    ...
    public function destroy(User $user)
    {
        ...
        return redirect()->route('cms.users.index')->with('success', 'Korisnik je uspješno izbrisan.');
    }
}